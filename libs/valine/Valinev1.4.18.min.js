...
! function (e, t) {
  ...
  return function (e) {
    ...
    function o(e) {
      return null == e ? "" : String(e).replace(c, r)
    }

    function a(e) {
      return null == e ? "" : String(e).replace(l, i)
    }
    var u = {
        "&": "&amp;",
        "<": "&lt;",
    ...
    */
    ...
    i.prototype.init = function (e) {
      ...
      try {
        ...
        var c = B.ds,
          f = r ? "&q=" + (0, h.RandomStr)() : "";
        B.params = "?d=" + (c.indexOf(n) > -1 ? n : "mp") + "&v=" + h.VERSION + f, B.hide = "hide" === n, B.cdn = /^https?\:\/\//.test(i) ? i : B.cdn, e.cfg.pageSize = isNaN(s) ? 10 : s < 1 ? 10 : s, l && (0, b.recordIPFn)(function (e) {
          return _.ip = e
        });
        var p = e.cfg.el || null,
          d = (0, A.default)(p);
        if (p = p instanceof HTMLElement ? p : d[d.length - 1] || null) {
          e.$el = (0, A.default)(p), e.$el.addClass("v").attr("data-class", "v"), B.hide && e.$el.addClass("hide-avatar"), e.cfg.meta = (e.cfg.guest_info || e.cfg.meta || h.defaultMeta).filter(function (e) {
          ...
          }(n), o && $.add(AV.Object.extend("Counter"), e.cfg.path), e.$el && e.bind()
        })
      } catch (t) {
    ...
    i.prototype.Q = function (e) {
      ...
      var e = this,
        ...
        c = function (e) {
          ...
          t.html(n.join("")), s = !0, t.find("i").on("click", function (e) {
            e.preventDefault(), D(o[0], " :" + (0, A.default)(this).attr("title") + ":")
          })
        };
      e.$emoji = {
        show: function () {
        ...
        show: function () {
          return O ? (e.$emoji.hide(), i.addClass("actived"), n.html(O).show(), T()) : e.$preview.hide(), e.$preview
        },
        hide: function () {
        ...
        i.limit(t), i.skip((n - 1) * t), i.find().then(function (i) {
          if (w.skip = w.size, i && i.length) {
            ...
            i.forEach(function (t) {
              o.push(t.id), S(t, e.$el.find(".vcards"), !0)
            }), e.Q(e.cfg.path, o).then(function (e) {
              (e && e.results || []).forEach(function (e) {
                S(e, (0, A.default)('.vquote[data-self-id="' + e.get("rid") + '"]'))
              })
      ...
      e.Q(e.cfg.path).count().then(function (t) {
        t > 0 ? (e.$el.find(".vcount").show().find(".vnum").text(t), F()) : e.$loading.hide()
      }).catch(function (t) {
      ...
      var S = function (t, n, r) {
        ...
        $ = function (t, n) {
          t.on("click", function (r) {
            ...
            (0, A.default)('.vreply-wrapper[data-self-id="' + o + '"]').append(a).find(".cancel-reply").show(), j = {
      ...
      ! function (t) {
        ...
        _.comment = "", v.comment.val(""), f(v.comment), v.comment.attr("placeholder", e.cfg.placeholder), j = {}, e.$preview.hide(), e.$el.find(".vpanel").append(e.$el.find(".vwrap")), e.$el.find(".cancel-reply").hide(), O = ""
      };
      var z = e.$el.find(".vsubmit"),
        ...
        M = function () {
          A.default.store.set("vlx", Date.now()), z.attr({
            disabled: !0
          }), e.$loading.show(!0);
          ...
          for (var i in _)
            ...
            "Anonymous" != _.nick && A.default.store.set(h.MetaCacheKey, {
              nick: _.nick,
              link: _.link,
              mail: _.mail
            });
            ...
            try {
              j.rid ? S(t, (0, A.default)('.vquote[data-self-id="' + j.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), S(t, e.$el.find(".vcards")), w.skip++), z.removeAttr("disabled"), e.$loading.hide(), e.reset()
            } catch (t) {
      ...
      var L = function (e, t) {
        ...
        N = function t(n, r) {
          ...
          if (i > 0) {
            ...
            D(o[0], u), U(a, function (s) {
              500 != s.code ? (o.val(o.val().replace(u, "![" + a.name + "](" + s.data.url + ")\r\n")), (0, l.default)(o[0]), ++r < i ? t(n, r) : z.removeAttr("disabled")) : (o.val(o.val().replace(u, "")), (0, l.default)(o[0]), e.$el.find(".status-bar").text(s.msg).empty(3e3), z.removeAttr("disabled"))
            })
          }
        },
        U = function (e, t) {
          var n = new FormData;
          n.append("image", e), n.append("fileId", e.name), A.default.ajax({
            url: "https://imgpro.pro/upload/upload.html",
            method: "post",
            body: n
          }).then(function (e) {
            e.json().then(t)
    ...
    d.code = function (e, t) {
      return '<pre><code class="hljs language-' + t + '">' + (t && hljs.getLanguage(t) ? hljs.highlight(t, e).value : c.default.escape(e)) + "</code></pre>"
    }, i.marked.setOptions({
      renderer: "hljs" in window ? d : new i.marked.Renderer,
      highlight: function (e, t) {
        return "hljs" in window ? t && hljs.getLanguage(t) && hljs.highlight(t, e, !0).value || hljs.highlightAuto(e).value : (0, s.default)(e)
      },
      gfm: !0,
      tables: !0,
      breaks: !0,
      ...
      return (0, i.marked)(p.default.parse(e, !0))
    }
  }, function (e, t, n) {
    "use strict";
    ...
    t.default = function (e) {
      return e = (0, i.default)({
        ...
        if ("jsonp" == e.method) {
          ...
          return e.body.callback = r, e.body.t = Date.now(), u.src = e.url + "?" + a(e.body), window[r] = function (e) {
        ...
        e.url = e.url + "?" + ("get" == e.method ? a(e.body) : ""), s.open(e.method || "get", e.url, !0), s.onload = function () {
    ...
    function i(e, t) {
      function n() {
        "\x3c!--" === e.substr(0, 4) ? d() : p.test(e) ? i(l, g) : f.test(e) && i(s, v), h()
      }
      ...
      function v(e, n, r, i) {
        function s(e, t, n, r, i) {
          l[t] = void 0 === n && void 0 === r && void 0 === i ? void 0 : o.decode(n || r || i || "")
        }
        var l = {},
          f = a(n),
          p = u.voids[f] || !!i;
    ...
    function r(e, t) {
      ...
      function r(e, t, r) {
        ...
        var s = o(e);
        return h.ignoring ? void f(s) : -1 === (v.allowedTags || []).indexOf(s) ? void f(s) : v.filter && !v.filter({
          tag: s,
          attrs: t
        }) ? void f(s) : (n("<"), n(s), Object.keys(t).forEach(u), void n(r ? "/>" : ">"))
      }

      function s(e) {
        var t = o(e); - 1 !== (v.allowedTags || []).indexOf(t) && !1 === h.ignoring ? (n("</"), n(t), n(">")) : p(t)
      }
    ...
    ! function (e, n) {
      ...
      function s(e, t) {
        ...
        } else if (F.test(e)) return e.replace(C, _);
        return e
      }
      ...
      function p(e, t) {
        ...
        var n = -1 === e.indexOf(":");
        return "//" === t.substring(0, 2) ? n ? t : e.replace(z, "$1") + t : "/" === t.charAt(0) ? n ? t : e.replace(P, "$1") + t : e + t
      }
      ...
      var H = A.options,
        ...
        Y = V.parse,
        ee = U.lex;
      e.Lexer = U, e.Parser = V, e.Renderer = Q, e.Slugger = W, e.TextRenderer = q, e.Tokenizer = M, e.getDefaults = a, e.lexer = ee, e.marked = A, e.options = H, e.parse = X, e.parseInline = J, e.parser = Y, e.setOptions = K, e.use = G, e.walkTokens = Z, Object.defineProperty(e, "__esModule", {
        value: !0
      })
    })
  }, function (e, t, n) {
    ...
    */
    ...
    function m(e) {
      ...
      var t = J.call(Z.call(e), /^function\s*([\w$]+)/);
      return t ? t[1] : null
    }
    ...
    e.exports = function e(t, n, F, T) {
      function I(t, n, r) {
        if (n && (T = oe.call(T), T.push(n)), r) {
          ...
          return v(R, "quoteStyle") && (i.quoteStyle = R.quoteStyle), e(t, i, F + 1, T)
        }
        return e(t, R, F + 1, T)
      }
      var R = n || {};
      ...
      if (d(t)) {
        var Z = ce ? Y.call(String(t), /^(Symbol\(.*\))_[^)]*$/, "$1") : le.call(t);
        return "object" != typeof t || ce ? Z : C(Z)
      }
      if (k(t)) {
        for (var J = "<" + te.call(String(t.nodeName)), ee = t.attributes || [], ne = 0; ne < ee.length; ne++) J += " " + ee[ne].name + "=" + i(o(ee[ne].value), "double", R);
        return J += ">", t.childNodes && t.childNodes.length && (J += "..."), J += "</" + te.call(String(t.nodeName)) + ">"
      }
      if (a(t)) {
        if (0 === t.length) return "[]";
        var ae = $(t, I);
        return V && !O(ae) ? "[" + j(ae, V) + "]" : "[ " + ie.call(ae, ", ") + " ]"
      }
      if (l(t)) {
        var se = $(t, I);
